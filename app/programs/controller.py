...
def list():
    ...
    programs_list = Programs.get_all()
    return render_template('programs.html', program_form=program_form, programs=programs_list, colleges=colleges_list, username=session.get('username'))
...
def add():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            programs_list = Programs.get_all()
            return render_template('programs.html', program_form=form, programs=programs_list, colleges=colleges_list, show_modal=True)
    else:
...
def update():
    ...
    if request.method == 'GET':
        ...
        program_form = ProgramForm()
        program_form.college_code.choices = choices
        return render_template('programs.html', program_form=program_form, edit_form=form, programs=programs_list, colleges=colleges_list, show_edit_modal=True, edit_code=code)
    ...
    if request.method == 'POST':
        ...
        if form.validate_on_submit():
            ...
            try:
                ...
                program_form = ProgramForm()
                program_form.college_code.choices = choices
                return render_template('programs.html', program_form=program_form, edit_form=form, programs=programs_list, colleges=colleges_list, show_edit_modal=True, edit_code=original_code)
        else:
            flash('Please correct the errors in the form.', 'danger')
            programs_list = Programs.get_all()
            program_form = ProgramForm()
            program_form.college_code.choices = choices
            return render_template('programs.html', program_form=program_form, edit_form=form, programs=programs_list, colleges=colleges_list, show_edit_modal=True, edit_code=request.form.get('original_code'))
